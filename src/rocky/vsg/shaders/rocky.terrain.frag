...
#if defined(RK_WIREFRAME_OVERLAY) // NOT SUPPORTED FOR INTEL && defined(GL_NV_fragment_shader_barycentric)
    // outlines - debugging
    // NOT SUPPORTED FOR INTEL float b = min(gl_BaryCoordNV.x, min(gl_BaryCoordNV.y, gl_BaryCoordNV.z))*32.0;
